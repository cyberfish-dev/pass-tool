    ...
    return (
        ...
        <Card className="rounded-2xl shadow-md">
            <CardContent className="space-y-4 p-6">
                ...
                <p className="text-sm">
                    <strong>PassTool</strong> is an open-source password generator and vault that puts{" "}
                    <span className="text-emerald-500 font-medium">your privacy first</span>.
                </p>
                ...
                <div>
                    <h3 className="text-md font-medium mt-6 mb-2">Open Source for Transparency</h3>
                    <p className="text-sm">
                        PassTool is fully open source on GitHub. You can inspect the code, contribute,
                ...
                <div>
                    ...
                    <p className="text-sm mb-4">
                        We believe password tools should be:
                    </p>
