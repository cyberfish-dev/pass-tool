      ...
      <Card className="rounded-2xl shadow-md">
        <CardContent className="space-y-4 p-6">
          ...
          <div className="text-sm">
            ...
            <br />
            <br />
            At PassTool, we respect your privacy and are committed to protecting
            it. This Privacy Policy explains what information we collect and how
            we use it.
            <br />
            <br />
            ...
            entries, remains entirely on your device. We do not store, transmit,
            or access this data.
            <br />
            <br />
            3. Local Storage
            ...
            localStorage. Only you have access to this data, and it never leaves
            your device.
            <br />
            <br />
            ...
            general usage trends (e.g., page visits). No personally identifiable
            ...
            <br />
            We may update this Privacy Policy. If we do, the “last updated” date
